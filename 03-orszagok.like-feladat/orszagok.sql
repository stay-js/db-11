START TRANSACTION;
DROP DATABASE IF EXISTS `foldrajz`;

CREATE DATABASE IF NOT EXISTS `foldrajz`
...
CREATE TABLE IF NOT EXISTS `orszagok` (
  ...
  `nepesseg` int NOT NULL DEFAULT '0',
  `nep_fovaros` int NOT NULL DEFAULT '0',
  ...
  `telefon` int NOT NULL DEFAULT '0',
  `gdp` int NOT NULL DEFAULT '0',
  `kat` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ;

TRUNCATE TABLE `orszagok`;
...
(31, 'ÍRORSZÁG', 'DUBLIN', 'Európa:Britt-szigetek', '70283.00', 'köztársaság', 3800, 1000, 'IRL', 'IRORSZAG               IRELAND', 'DUBLIN', 'euró', 'EUR', '100 eurocent', 353, 38430, 1),
