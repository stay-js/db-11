...
(1, 'hétfo', 'Mariann', 'élelmiszer', 'tej', 2, 280),
(2, 'hétfo', 'Mariann', 'élelmiszer', 'sajt', 1, 1250),
(3, 'hétfo', 'Mariann', 'élelmiszer', 'krumpli', 5, 120),
(4, 'hétfo', 'Lajos', 'élelmiszer', 'sonka', 0.5, 2400),
(5, 'hétfo', 'Lajos', 'élelmiszer', 'kolbász', 2, 800),
(6, 'hétfo', 'Bence', 'közlekedés', 'bérlet', 1, 3500),
(7, 'hétfo', 'Bence', 'higiénia', 'eldobható borotva', 1, 800),
(8, 'hétfo', 'Emese', 'higiénia', 'sampon', 1, 1200),
(9, 'hétfo', 'Emese', 'elektronika', 'telefon', 1, 120000),
